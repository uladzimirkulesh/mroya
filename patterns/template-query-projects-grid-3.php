<?php
/**
 * Title: List of projects, grid (style 3)
 * Slug: mroya/template-query-projects-grid-3
...
?>
<!-- wp:query {"metadata":{"name":"<?php echo esc_html_x( 'List of projects, grid (style 3)', 'Name for the List of projects pattern', 'mroya' ); ?>"},"query":{"perPage":12,"pages":0,"offset":0,"postType":"uk-project","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"wide","layout":{"type":"constrained"}} -->
<div class="wp-block-query alignwide">
	<!-- wp:post-template {"align":"wide","className":"is-layout-projects-grid--3","layout":{"type":"grid","columnCount":5}} -->
