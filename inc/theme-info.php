			...
			<div class="columns">
				<div class="column column--left">
					...
					<ul>
						...
						<li><?php echo esc_html_x( 'Carefully crafted patterns.', 'Theme info page text', 'mroya' ); ?></li>
				...
				<div class="column column--right">
					...
					<p class="theme-description"><?php echo esc_html_x( 'Mroya Premium unlocks the full potential of the Mroya theme and its child themes with smooth, professional animations.', 'Theme info page text', 'mroya' ); ?></p>
